...
public class UserInterface_GUI extends JFrame implements ActionListener
{
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        // Set frame
        setTitle("The Taj Restaurant Management System");
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("The Taj Restaurant Management System");
        ...
        taMessage.setText("Wellcome Nikhil Singh!!");
    ...
    private class OrderListPanel extends JPanel implements ActionListener
    {
        ...
        public OrderListPanel()
        {
           ...
           /*  btnNewOrder     = new JButton("New");
            ...
            // Improved Button Initialization and Layout Code

// Create a new JButton with improved design
btnNewOrder = new JButton("New");
btnNewOrder.setFocusPainted(false);
btnNewOrder.setFont(new Font("SansSerif", Font.BOLD, 14));
btnNewOrder.setBackground(new Color(70, 130, 180));  // Steel blue color
btnNewOrder.setForeground(Color.WHITE);
btnNewOrder.setBorder(new RoundedBorder(10)); 
...
btnNewOrder.addMouseListener(new java.awt.event.MouseAdapter() {
    public void mouseEntered(java.awt.event.MouseEvent evt) {
        btnNewOrder.setBackground(new Color(100, 149, 237));  // Lighter blue on hover
    }
    public void mouseExited(java.awt.event.MouseEvent evt) {
        btnNewOrder.setBackground(new Color(70, 130, 180));   // Original color
    }
});
...
this.add(btnNewOrder);
           ...
           /*  btnEditOrder    = new JButton("Edit");
            ...
            // Enhanced "Edit" Button Initialization with Hover Effect and Improved Design

// Create the "Edit" button with improved design
btnEditOrder = new JButton("Edit");
btnEditOrder.setFocusPainted(false);
btnEditOrder.setFont(new Font("SansSerif", Font.BOLD, 14));
btnEditOrder.setBackground(new Color(70, 130, 180));  // Steel blue color
btnEditOrder.setForeground(Color.WHITE);
btnEditOrder.setBorder(new RoundedBorder(10)); 
...
btnEditOrder.addMouseListener(new MouseAdapter() {
    public void mouseEntered(MouseEvent evt) {
        btnEditOrder.setBackground(new Color(100, 149, 237));  // Lighter blue on hover
    }
    public void mouseExited(MouseEvent evt) {
        btnEditOrder.setBackground(new Color(70, 130, 180));   // Original color
    }
});
...
this.add(btnEditOrder);
          ...
          /*   btnCloseOrder   = new JButton("Close");
            ...
            // Enhanced "Close" Button Initialization with Hover Effect and Improved Design

// Create the "Close" button with improved design
btnCloseOrder = new JButton("Close");
btnCloseOrder.setFocusPainted(false);
btnCloseOrder.setFont(new Font("SansSerif", Font.BOLD, 14));
btnCloseOrder.setBackground(new Color(70, 130, 180));  // Steel blue color
btnCloseOrder.setForeground(Color.WHITE);
btnCloseOrder.setBorder(new RoundedBorder(10));  // Rounded corners
btnCloseOrder.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));

// Add hover effect
btnCloseOrder.addMouseListener(new MouseAdapter() {
    public void mouseEntered(MouseEvent evt) {
        btnCloseOrder.setBackground(new Color(100, 149, 237));  // Lighter blue on hover
    }
    public void mouseExited(MouseEvent evt) {
        btnCloseOrder.setBackground(new Color(70, 130, 180));   // Original color
    }
});
...
this.add(btnCloseOrder);
          ...
          /*   btnCancelOrder  = new JButton("Cancel");
            ...
            // Enhanced "Cancel" Button Initialization with Hover Effect and Improved Design

// Create the "Cancel" button with improved design
btnCancelOrder = new JButton("Cancel");
btnCancelOrder.setFocusPainted(false);
btnCancelOrder.setFont(new Font("SansSerif", Font.BOLD, 14));
btnCancelOrder.setBackground(new Color(70, 130, 180));  // Steel blue color
btnCancelOrder.setForeground(Color.WHITE);
btnCancelOrder.setBorder(new RoundedBorder(10));  // Rounded corners
btnCancelOrder.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));

// Add hover effect
btnCancelOrder.addMouseListener(new MouseAdapter() {
    public void mouseEntered(MouseEvent evt) {
        btnCancelOrder.setBackground(new Color(100, 149, 237));  // Lighter blue on hover
    }
    public void mouseExited(MouseEvent evt) {
        btnCancelOrder.setBackground(new Color(70, 130, 180));   // Original color
    }
});
